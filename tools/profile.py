...
from mmdet3d.prune.utils import model_summary
import numpy as np
# import debugpy
# debugpy.listen(7676)
...
def single_gpu_profile(model,
    ...
    print('Infer time (ms/image) : {}'.format(np.mean(times)))
    print('FPS : {}'.format(batch_size*1e+3 / np.mean(times)))

    dummy_input = torch.randn()
    flops = model_summary(model, dummy_input.cuda())
