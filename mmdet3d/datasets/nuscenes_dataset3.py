...
from dd3d.datasets.nuscenes import NuscenesDataset as DD3DNuscenesDataset


@DATASETS.register_module()
class NuScenesDataset3(NuScenesDataset):
    def __init__(self, frames=(0,),mono_cfg=None, overlap_test=False,*args, **kwargs):
