...
from ops_dcnv3.modules import DCNv3_pytorch, DeformPool
...
class InternImage(nn.Module):
    ...
    def __init__(self,
                 core_op=['DCNv3','DCNv3','DeformPool','DeformPool'],
                 channels=64,
                 depths=[3, 4, 18, 5],
                 groups=[3, 6, 12, 24],
                 mlp_ratio=4.,
        ...
        logger.info(f'using core type: {self.core_op[0], self.core_op[1], self.core_op[2], self.core_op[3]}')
        ...
        for i in range(self.num_levels):
            ...
            level = InternImageBlock(
                core_op=getattr(dcnv3, self.core_op[i]),
    ...
    def _init_deform_weights(self, m):
        for i in range(0,4):
            if isinstance(m, getattr(dcnv3, self.core_op[i])):
                m._reset_parameters()
